# AirFly
## 机场订阅一键生成ip代理池，让机场起飞！
- 目前工具只支持v2rayN格式的机场订阅链接，暂不支持clash的订阅，请自行转换。
- 如果订阅的链接中的节点在v2rayN中能够正常连接但是本工具中连接失败，请提issue反馈。
...
- 同时监听 http、socks5协议 端口（建议本地和内网访问）
airfly -l mixed://:6666 -u "机场订阅链接1" -u "机场订阅链接2"

- 带用户名和密码认证的 http、socks5协议 端口 （建议公网访问）
airfly -l mixed://user:pass@:6666 -u "机场订阅链接1" -f "机场订阅文件2"

- 只监听 http 协议 端口
airfly -l http://:6666 -f "机场订阅文件"

- 只监听 socks5 协议 端口
airfly -l socks5://:6666 -u "机场订阅链接"
